...
Game.prototype.handleMouseDown = function(e) {
    ...
    switch (Tools.current) {
        case Tools.BUILD:
            ...
            alert("Building already exists on this tile.");
        }
    ...
    for (var row = startRow; row < rowCount; row++) {
        for (var col = startCol; col < colCount; col++) {
            ...
            if (this.tileMap[row] != null && this.tileMap[row][col] != null) {
                // Place building
                if (this.tileMap[row][col] instanceof tile1 ||
                    this.tileMap[row][col] instanceof tile2 ||
                    this.tileMap[row][col] instanceof tile3){
